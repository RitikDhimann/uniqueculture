        ...
        <div className="min-h-screen flex items-center justify-center p-6 relative pt-32 bg-primary">
            ...
            >
                <div className="mb-12 text-center space-y-2">
                    <h1 className="text-2xl md:text-3xl font-heading tracking-[0.4em] text-secondary uppercase">Reset Password</h1>
                    <p className="text-[9px] font-mono tracking-[0.3em] text-accent uppercase font-black">Enter your email to reset</p>
                </div>
                ...
                <form className="space-y-8">
                    ...
                    <div className="pt-4">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.99 }}
                            className="w-full bg-secondary text-primary font-heading text-lg py-4 tracking-[0.3em] hover:bg-black transition-colors uppercase"
                        >
                            Send Reset Link
                        </motion.button>
                    </div>
                ...
                <div className="mt-16 pt-8 border-t border-secondary/5 text-center">
                    <p className="text-[10px] font-mono tracking-widest uppercase text-accent font-black">
                        Remembered? <Link to="/login" className="text-secondary font-black hover:underline ml-2">Login</Link>
                    </p>
                </div>
            </motion.div>
